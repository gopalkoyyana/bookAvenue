...
import { MapPin, Users, Phone, Mail, Star, Building2, Hotel, PartyPopper, Home } from "lucide-react";
    ...
    return (
        ...
        >
            <div className="flex flex-col md:flex-row">
                {/* Image Section */}
                <div className="relative w-full md:w-64 h-48 bg-gradient-to-br from-purple-100 to-indigo-100 flex items-center justify-center">
                    ...
                    {/* Type Badge */}
                    <div className="absolute top-3 left-3 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-medium text-purple-600 flex items-center gap-1">
                ...
                <div className="flex-1 p-5 relative">
                    <div className="mb-3">
                        <div className="flex items-start justify-between mb-1">
                            <h3 className="text-xl font-bold text-gray-800 pr-6">{venue.name}</h3>
                            {date && (
                                <div
                                    className={`w-3 h-3 rounded-full shadow-sm flex-shrink-0 mt-2 ${isAvailable ? "bg-green-500 animate-pulse" : "bg-red-500"}`}
                    ...
                    <div className="flex flex-wrap gap-3 text-sm mb-4">
                        ...
                        {venue.contact.website && (
                            <div className="flex items-center gap-1 text-gray-600">
                                <span className="text-purple-500 text-xs border border-purple-200 px-1.5 py-0.5 rounded">Website</span>
                            </div>
                        )}
                    </div>
